          ...
          <!-- your content here -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <hr>
                                <label for="nome">Título da postagem: </label><strong> <?=$projeto->titulo;?></strong><br>
                        </div>
                        <?php } ?>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="card col-md-12" style="padding-top: 20px;">
                    <form  class="col-md-12" method="POST" enctype="multipart/form-data" action="alterar-imagens-projeto.php" style="padding-bottom: 15px;">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr class="text-center">
                                    <td><?php if ($projeto->arquivo == Null) {  ?>
                                    <img src="arquivos/sem-imagem.png" alt="" width="100" height="100" />             
                                    <?php } else { ?>
                                    <img src="arquivos/<?=$projeto->arquivo;?>" alt="" width="120" height="120"/> 
                                    <?php } ?>
                                    <br>
