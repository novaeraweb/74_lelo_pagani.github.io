                    ...
                    <form  class="col-md-12" method="POST" action="alterar-postagem.php">
                      <br><br>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="titulo" id="titulo" class="form-control" value="<?=$blog->titulo;?>">
                        </div>
                        <br>
                        <div class="form-group">
                          <label for="descricao_breve">Descrição Breve:</label><br>
                          <textarea name="descricao_breve" id="descricao_breve" cols="30" rows="10" class="form-control"><?=$blog->descricao_breve;?></textarea>
                        </div>
                        <br>
                        <div class="form-group">
                          <label for="descricao_longa">Descrição Longa:</label><br>
                          <textarea name="descricao_longa" id="descricao_longa" cols="30" rows="10" class="form-control"><?=$blog->descricao_longa;?></textarea>
                        </div>
                        <br>
                        <div class="form-group">
