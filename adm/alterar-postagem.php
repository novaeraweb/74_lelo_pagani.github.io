...
// Insert EN
$updateSQL = "UPDATE blog SET titulo = '$titulo', descricao_breve = '$descricao_breve', descricao_longa = '$descricao_longa', link = '$link', video = '$video' , ativo = '$ativo' WHERE idblog ='$id'"; 
